...
const workflowSteps: WorkflowStep[] = [
    {
        id: "1",
        agent: "codex-importer@workspace",
        tokens: "10k tokens",
        status: "Scanning recent sessions...",
        step: "Step 1 of 3",
    },
    {
        id: "2",
        agent: "vault-sync@workspace",
        tokens: "20k tokens",
        status: "Writing Obsidian notes...",
        step: "Step 2 of 3",
    },
    {
        id: "3",
        agent: "memory-indexer@workspace",
        tokens: "15k tokens",
        status: "Indexing local project memory...",
        step: "Step 3 of 3",
    },
];
...
export function AgentWorkflowBlock() {
    ...
    return (
        <div ref={blockRef} className="relative min-h-[400px] md:min-h-[500px] flex p-6 md:p-12 overflow-visible">
                ...
                <div className="flex items-start gap-3 flex-1">
                    ...
                    <div className="flex-1 min-w-0 flex flex-col divide-y divide-border">
                        <div className="flex gap-3 items-center p-2">
                            ...
                            <h4 className="text-sm font-medium text-foreground">{step.agent}</h4>
                            <span className="hidden md:block text-xs text-foreground whitespace-nowrap">{step.tokens}</span>
                        </div>
                        <div className="flex items-center justify-between w-full p-2">
                            <p className="text-sm text-muted-foreground">{step.status}</p>
                            <span className="hidden md:block text-xs text-muted-foreground whitespace-nowrap mt-1">{step.step}</span>
                        </div>
                    </div>
                </div>
