...
const buttonText = "Save to memory";
const codeBlock = {
    fileName: "memory.ts",
    imports: [
        "import { writeMemoryNote } from '@/lib/locality';",
        "import { getSessionSummary } from '@/lib/imports';",
    ],
    before: [
        "const summary = getSessionSummary(session);",
        "writeMemoryNote(project, summary);",
    ],
    after: [
        "const summary = getSessionSummary(session);",
        "",
        "writeMemoryNote(project, {",
        "  ...summary,",
        "  source: 'codex',",
        "});",
    ],
