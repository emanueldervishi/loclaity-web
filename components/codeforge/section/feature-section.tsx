...
import { OrbitingIconsBurst } from "@/components/codeforge/animations/orbiting-icons-burst";
import { DottedMap } from "@/components/codeforge/ui/dotted-map";
                                ...
                                <OrbitingIconsBurst
                                    items={[
                                        ...
                                        },
                                        {
                                            ...
                                            className: "",
                                            icon: (
                                                <Icons.vercel className="size-full" />
                                            ),
                                        },
                                        {
                                            id: 3,
