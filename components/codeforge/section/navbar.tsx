...
import { ThemeToggle } from "@/components/codeforge/theme-toggle";
...
} from "@/components/codeforge/ui/navigation-menu";
import {
  Accordion,
  AccordionContent,
  AccordionItem,
  AccordionTrigger,
} from "@/components/codeforge/ui/accordion";
                  ...
                  <div className="flex flex-col">
                    ...
                    <div className="flex items-center justify-center border-border mx-2 mb-2 bg-muted px-10 py-6 rounded-3xl border">
                      <p className="text-base text-muted-foreground">
                        Need help rolling out Locality?{" "}
                        <Link
                          href="/pricing"
    ...
    >
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6">
        ...
        <div className="flex items-center gap-2">
          <ThemeToggle />
          <Button asChild className="hidden md:flex rounded-lg bg-primary px-5 text-sm font-medium text-primary-foreground hover:bg-primary/90">
            <Link href="/login" aria-label="Start Locality">
              {siteConfig.cta}
            </Link>
          </Button>
          <HamburgerButton
