...
export function PricingSection() {
    ...
    const paidPlans = pricing.pricingItems
        ...
        .sort((a, b) => {
            if (a.name === "Go") return -1;
            if (b.name === "Go") return 1;
            return 0;
        });
                    ...
                    <div className="col-span-2 flex flex-col gap-4 p-8 md:p-14">
                        <div className="space-y-4">
                            <h3 className="text-3xl font-medium tracking-tighter md:text-4xl">
                                Start free. Remember more. Scale clean.
                            </h3>
                            <p className="text-balance text-muted-foreground">
                                The Codex importer is free. Upgrade when durable,
                                multi-tool memory becomes part of your daily
                                workflow.
                            </p>
                        </div>
                        <div className="pt-4">
                            <div className="inline-flex rounded-xl border border-border bg-card/70 px-4 py-2 text-sm text-muted-foreground">
                                Monthly billing
                            </div>
                        </div>
                    </div>
